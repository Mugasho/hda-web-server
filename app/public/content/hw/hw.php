...
if (!is_null($pages)) {
    ...
    $facilities = $db->get_hws($limit, $next_id, $search);
...
<section class="overlape">
    <div class="block no-padding">
        <div data-velocity="-.1"
             style="background: url(<?php echo VENDOR; ?>hunt/images/resource/section_bg_health_large.jpg) repeat scroll 50% 422.28px transparent;"
            ...
            <div class="row no-gape">
                    ...
                    <form method="get" name="search_form">
                        <div class="widget">
                            <div class="search_widget_job">
                                <div class="field_w_search">
                                    <input type="text" placeholder="Search Keywords" id="search" name="search"
                                           onkeyup="search_input('search',this.value)"/>
                                    <i class="la la-search"></i>
                                </div><!-- Search Widget -->
                                <div class="field_w_search">
                                    <input type="text" placeholder="All Locations" id="location" name="location"
                                           onkeyup="search_input('search',this.value)"/>
                        ...
                        <div class="widget">
                            ...
                            <div class="type_widget">
                                <p class="flchek"><input type="checkbox" name="choosetype" id="33r"><label for="33r">Inactive
                                        (9)</label></p>
                                <p class="ftchek"><input type="checkbox" name="choosetype" id="dsf"><label for="dsf">Active
                                        (8)</label></p>
                            </div>
                        </div>
                        <div class="widget">
                        ...
                        <div class="widget">
                            ...
                            <div class="specialism_widget">
                                <div class="simple-checkbox">
                                    ...
                                    <p><input type="checkbox" name="masters" id="masters"><label
                                                for="masters">Masters</label></p>
                                    <p><input type="checkbox" name="bachelors" id="bachelors"><label for="bachelors">Bachelors</label>
                                    </p>
                                    <p><input type="checkbox" name="certificate" id="certificate"><label
                                                for="certificate">Certificate</label></p>
                ...
                <div class="col-lg-8 column">
                    <div class="modrn-joblist">
                        ...
                        <div class="filterbar">
                            <span class="emlthis"><a href="<?php echo BASE_PATH ?>" title=""><i
                                            class="la la-envelope-o"></i> Email me this List</a></span>
                            <div class="sortby-sec">
                                ...
                                <select data-placeholder="20 Per Page" class="chosen"
                                        onchange="search_page('limit',this.value)">
                            ...
                            <h5><?php echo count($facilities); ?> Health workers</h5>
                        </div>
                    </div><!-- MOdern Job LIst -->
                    <div class="job-list-modern">
                        <div class="job-listings-sec"><?php

                            foreach ($facilities as $hw) {
                            ...
                            <div class="block">
                                <div class="pagination">
                                    <ul><?php
                                        echo '<li class="prev"><a onclick="search_page(\'pg\',1)"><i class="la la-long-arrow-left"></i> Prev</a></li>';
                                        for ($i = $start; $i <= $last; $i++) {
                                            $status = $i == $current ? 'class="active"' : '';
                                            echo '<li ' . $status . '><a onclick="search_page(\'pg\',' . $i . ')">' . $i . '</a></li>';
                                        }
                                        echo '   <li class="next"><a  onclick="search_page(\'pg\',' . $pages . ')">Next <i class="la la-long-arrow-right"></i></a></li>';
                                        ?>
                                    </ul>
                                </div>
                            </div>
