                ...
                <div class="col-lg-12">
                    <div class="cand-single-user">
                        <div class="share-bar circle">
                            <a href="#" title="" class="share-google"><i class="la la-google"></i></a><a href="#"
                                                                                                         title=""
                                                                                                         class="share-fb"><i
                                        class="fa fa-facebook"></i></a><a href="#" title="" class="share-twitter"><i
                                        class="fa fa-twitter"></i></a>
                        </div>
                        <div class="can-detail-s">
                            <div class="cst"><img
                                        src="<?php echo !empty($hw['profile_pic']) ? $hw['profile_pic'] : VENDOR . 'img/doctor.png'; ?>"
                                        alt=""/></div>
                            <h3><?php echo $hw['surname'] . ' ' . $hw['first_name'] . ' ' . $hw['other_names']; ?></h3>
                            <span><i><?php echo $hw['qualification']; ?></i></span>
                            <p><a href="<?php echo BASE_PATH; ?>email-protection" class="__cf_email__"
                                  data-cfemail="mugalink2@gmail.com">[email&#160;protected]</a></p>
                            ...
                            <div class="col-lg-8 column">
                                <div class="cand-details" id="about"><?php
                                    ...
                                    <div class="recent-jobs">
                                            <h2>Current Jobs</h2>
                                            <div class="job-list-modern" id="employers">
                                                <div class="job-listings-sec no-border"><?php
                                                    foreach ($positions as $position) {
                                                        echo '
                                                <div class="job-listing wtabs">
                                                    <div class="job-title-sec">
                                                        <div class="c-logo"> <img src="' . VENDOR . 'hunt/images/resource/first-aid-kit.png" alt=""> </div>
                                                        <h3><a href="' . BASE_PATH . 'facility/detail/' . $position['id'] . '/" title="">' . $db->limitChars($position['facility'], 25) . '</a></h3>
                                                        <span>' . $position['position'] . '</span>
                                                        <div class="job-lctn"><i class="la la-map-marker"></i>' . $position['address'] . '</div>
                                                    </div>
                                                    <div class="job-style-bx">
                                                        <span class="job-is ft">Full time</span>
                                                        <span class="fav-job"><i class="la la-heart-o"></i></span>
                                                        <i>' . $db->time_ago(new DateTime($position['date_added']), new DateTime('now')) . '</i>
                                                    </div>
                                                </div>
                                                ';
                                                    } ?>
