...
<script type="text/javascript">
    var path = <?php echo json_encode(CONTENT_PATH); ?>;
</script>
<div class="navbar navbar-light navbar-expand-lg">
    ...
    <a class="navbar-brand" href="/"><img src="<?php echo CONTENT_PATH?>images/icon/logo-blue.png" alt=""/></a>
    <a class="navbar-brand-sm" href="/"><img src="<?php echo CONTENT_PATH?>images/icon/logo-blue.png" alt=""/></a>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
        <form >
            <div class="navbar-search">
                <div class="input-group iconfont icon-right">
                    <input class="form-control navbar-search__input" name="search" type="text" placeholder="Search"/><span class="input-icon iconfont iconfont-search"></span>
                </div>
            </div>
        </form>
          ...
          <span class="navbar-notify__amount">3</span>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-notifications">
                ...
                <div class="navbar-dropdown-notifications__body">
                    <div class="navbar-dropdown-notifications__body-empty"><img class="navbar-dropdown-notifications__body-empty-image" src="<?php echo CONTENT_PATH?>images/empty-notifications.png" alt=""/>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-notifications navbar-dropdown-messages">
                ...
                <div class="navbar-dropdown-notifications__body navbar-dropdown-notifications__body-messages js-scrollable">
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="<?php echo CONTENT_PATH?>images/users/user-4.png" alt="" width="40" height="40"/>
                    ...
                    <div class="navbar-dropdown-notifications__item">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="<?php echo CONTENT_PATH?>images/users/user-5.png" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
                    ...
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="<?php echo CONTENT_PATH?>images/users/user-6.png" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
                    ...
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="<?php echo CONTENT_PATH?>images/users/user-7.png" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
        ...
        <div class="dropdown navbar-dropdown">
            <a class="dropdown-toggle navbar-dropdown-toggle navbar-dropdown-toggle__user" data-toggle="dropdown" href="#">
                <img src="<?php echo CONTENT_PATH?>images/users/user-3.png" alt="" class="navbar-dropdown-toggle__user-avatar">
            ...
            <div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu__user">
                <div class="navbar-dropdown-user-content">
                    <div class="dropdown-user__avatar"><img src="<?php echo CONTENT_PATH?>images/users/user-3.png" alt=""/></div>
