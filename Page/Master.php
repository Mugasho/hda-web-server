...
class Master
{
    ...
    {
        if (file_exists('app/admin/content/' . $pageContent)) {
            require 'app/admin/content/' . $pageContent;
        }

    }

    function getFrontContent($pageContent)
    {
        if (file_exists('app/public/content/' . $pageContent)) {
            require 'app/public/content/' . $pageContent;
        }
